...
```text
فهم البنية والروح → حذف التفاصيل غير المهمة → استخلاص الشكل المركزي → وضعه في حقل أفقي غير منتظم → إعادة رسمه بخط شمعي وطبقات ورق وقليل من الذهب → إكماله بالفراغ وحبيبات Risograph
```

## سمات النتيجة

- الواقع وتصميم الورق ذي الطبقتين داخل لوحة كاملة واحدة؛ المقارنة 50:50 تماماً بلا شريط ثالث.
- أرضية من ورق عاجي خشن الألياف، وفي الوسط حقل لوني أفقي ضيق وغير منتظم وموضوع صغير كختم.
- خطوط شمعية داكنة مطفأة ومرتخية، ويضيء قدر ضئيل من الذهب الخطوط المهمة فقط.
- يمكن للموضوع تجاوز الحقل إلى الفراغ، بلا ظلال واقعية أو زخرفة معقدة، مع تقادم خفيف وحبيبات Risograph.
- عبارات إنجليزية صغيرة ولينة وعفوية كالملاحظات الخاصة، ولا تطغى على الموضوع.
